  ...
  return (
    <Router className="App">
      <Switch>
        ...
        <Route path="/create-account" component='/'></Route> {/* {createAccount} */}
        <Route path="/kudos" exact component={kudosPage}></Route> {/* {kudosPage} */}
        <Route path="/kudos/:id" exact component='/'></Route> {/* {kudoId} */}
        <Route path="/comment" exact component='/'></Route> {/* {commentKudo} */}
        <Route path="/create-kudo" exact component='/'></Route> {/* {createKudo} */}
      </Switch>
    </Router>
  );
}
